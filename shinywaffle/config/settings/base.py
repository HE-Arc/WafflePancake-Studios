# -*- coding: utf-8 -*-
"""
Django settings for Shiny Waffle project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'shinywaffle.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Julien M'Poy, Alexandre Serex & Joël Vaucher""", 'you@example.com'),
]
...
DATABASES = {
  'default': {
    ...
    'NAME': os.environ.get('POSTGRES_NAME', 'shinywaffle'),
    'USER': os.environ.get('POSTGRES_USER', 'shinywaffle'),
    'PASSWORD': os.environ.get('POSTGRES_PASSWORD', 'shinywaffle'),
...
ACCOUNT_ADAPTER = 'shinywaffle.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'shinywaffle.users.adapters.SocialAccountAdapter'
